...
namespace BookFavor.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(netbookContext context)
        {
            _context = context;
        }
        ...
        {
            var all = await _context.Publishers.ToListAsync();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //var countBooks = (from b in _context.Books where b.PublisherId = id).Count();
